...
`ggplot` is one of the foundational libraries for making maps in R. Below I detail the process of using `ggplot` to make maps when your data are in *shapefile* (@sec-shapefiles) format.

...
Sometimes we have map data that come in the form of location data where the *latitude* and *longitude* (@sec-latitude-longitude) of each participant or location is listed in the data set.

Below I describe the process of working with such location data. Location data can easily be combined with *shapefiles*  (@sec-shapefiles) in `ggplot`.

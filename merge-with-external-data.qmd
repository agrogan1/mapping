...
Here I am using the `wrld_simpl` dataset of country outlines that is available in several R packages (@sec-shapefiles2). I read this data into an object called `world`.

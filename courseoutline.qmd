...
Mapping is fun. Many people enjoy looking at maps, and find them informative and helpful. Many people find it very fun to learn how to make maps. At the same time, making even basic maps with geographic data can be challenging. Making an aesthetically pleasing and useful map can also be very challenging. We will work hard in this course to learn these important skills. At the same time, we will have fun doing so!
:::
...
1. Introduction
    ...
    + Introduction to Shapefiles (@sec-shapefiles) (and Possibly `sf` Objects) (@sec-sf) as GIS Data
...
2. Basic GIS Skills
    ...
    + Joining by Attribute (@sec-merging)
3. Data With Geographic Coordinates & Geographic Concepts
    + Data With Latitude and Longitude (@sec-location-data)
    + Coordinate Reference Systems (@sec-CRS)
4. Geocoding (@sec-geocoding)
5. Lab Day for Final Projects

## More Advanced Topics {#sec-moreadvanced}

1. Basemaps e.g. `leaflet` (@sec-leaflet)
2. Projections, projecting and re-projecting geographic data (@sec-projections)

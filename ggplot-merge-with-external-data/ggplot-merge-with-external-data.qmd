---
title: "ggplot Merge With External Data"
...
A common task in mapping is that I have a shapefile of map data, but want to merge in some external data from another source so that I can map that external data. Usually I want to use different colors to map that external data.
...
This tutorial builds upon another tutorial on [mapping with `ggplot`](https://agrogan1.github.io/mapping/ggplot/ggplot-map-demo.html).
...
write.csv(externaldata, file = "externaldata.csv")
...
> Data could also be mapped with another package like [`leaflet`](../leaflet/leaflet-map-demo).
